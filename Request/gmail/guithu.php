...
require_once '../../nduckien/connect.php';
require_once '../../nduckien/head.php';
require_once '../../nduckien/cauhinh.php';
require '../../pages/cap-nhat-thong-tin.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Check if the user is linked to an email
    // If the user is already linked to an email
    ...
    if ($isLinked) {
        ...
        if ($remainingMinutes <= 0) {
            ...
            " . $domain . "/request/gmail/verify-gmail?" . $verificationCode . "\n
            ...
            try {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'ngocrongdragonking@gmail.com'; // Change to your email
                $mail->Password = 'erlthhyxknomaxgx'; // Change to your password
                $mail->SMTPSecure = 'tls';
                $mail->Port = 587;

                // Set email information
                $mail->setFrom('ngocrongdragonking@gmail.com', 'Ngọc Rồng DragonKing'); // Change to your email and name
