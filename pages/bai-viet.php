                                            ...
                                            if ($row) {
                                                ...
                                                if ($_login === null) {
                                                    ...
                                                    if ($_admin == 1) {
                                                        if ($tinhtrang == 0) {
                                                            if (!$ghinhan) {
                                                                echo '<a href="../Request/tinhtrang.php?id=' . $_postsid . '&tinhtrang=2">[Ghi nhận]</a> ';
                                                            }
                                                            if (!$datraloi) {
                                                                echo '<a href="../Request/tinhtrang.php?id=' . $_postsid . '&tinhtrang=1">[Đã trả lời]</a> ';
                                                            }
                                                        } else if ($tinhtrang == 1) {
                                                            if (!$ghinhan) {
                                                                echo '<a href="../Request/tinhtrang.php?id=' . $_postsid . '&tinhtrang=2">[Ghi nhận]</a> ';
                                                            ...
                                                            if (!$thaoluan) {
                                                                echo '<a href="../Request/tinhtrang.php?id=' . $_postsid . '&tinhtrang=0">[Chưa trả lời]</a> ';
                                                            }
                                                        } else if ($tinhtrang == 2) {
                                                            if (!$datraloi) {
                                                                echo '<a href="../Request/tinhtrang.php?id=' . $_postsid . '&tinhtrang=1">[Đã trả lời]</a> ';
